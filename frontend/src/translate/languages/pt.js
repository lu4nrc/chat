    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          name: "Nome",
          default: "Padrão",
          farewellMessageLabel: "Insira protocolo dentro de {{}} em qualquer lugar de sua frase para habilitar a geração de protocolos.",
          farewellMessage:"Mensagem de finalização"
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
